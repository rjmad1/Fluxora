    ...
    data: [
      {
        ...
        senderAvatar: null,
        text: 'How does the Kafka fallback behavior handle partitioned queue offline events?',
        isOutbound: false,
        timestamp: new Date(Date.now() - 3600000 * 2),
      },
      {
        ...
        senderAvatar: null,
        text: 'We spool event batches locally to JSON log buffers before retrying the ClickHouse ingest stream!',
        isOutbound: true,
      ...
      },
      {
        ...
        platform: 'twitter',
        senderName: '@tech_growth_hub',
        senderAvatar: null,
        text: 'Just checked out the scaling simulator, absolutely incredible performance dashboards!',
        isOutbound: false,
        timestamp: new Date(Date.now() - 3600000 * 4),
      },
    ],
